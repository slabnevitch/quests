...
$(window).load(function() {
	...
	tl
		.from('.header-ellipses__main', 3, {rotation: 180, opacity: 0}, 1)
		.from('.header-ellipses__thin', 2, {rotation: -180, opacity: 0}, 0)
	...
	$('.header-play__button').magnificPopup({
		disableOn: 480,
		type: 'iframe',
		mainClass: 'mfp-fade',
		removalDelay: 160,
